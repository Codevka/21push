<template>
  <el-main class="infoQ">
    <el-table border :data="userContract" style="width: 100%">
      ...
      <el-table-column prop="contractId" label="订单编号" width="150"></el-table-column>
      <el-table-column prop="houseId" label="房源编号" width="150"></el-table-column>
      <el-table-column prop="rentTime" label="租房时间" width="150"></el-table-column>
      <el-table-column prop="contractTime" label="订单生成时间" width="150"></el-table-column>
      <el-table-column prop="contractDuration" label="订单持续时间" width="150"></el-table-column>
